...
class_index <- 1
component_index <- 1
hist(normalized_principal_coeffs_matrix[train_labels == class_index-1,class_index], breaks = 40)
mean(normalized_principal_coeffs_matrix[train_labels == class_index-1,class_index])
var(normalized_principal_coeffs_matrix[train_labels == class_index-1,class_index])
